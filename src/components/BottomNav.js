        ...
        <div className='flex justify-center'>
            <div className='fixed bottom-0 border w-full bg-white px-5 py-5 rounded-full -mb-1 drop-shadow-2xl'>
                <div class="flex justify-between">
                    ...
                    <div className='px-2'><BsGraphUp className='text-xl' /></div>
                    <div className='px-5 py-4 bg-sky-400 rounded-full flex justify-center -mt-10'><BsHouseFill className='text-white text-3xl' /></div>
                    <div className='px-2'><BsFileText className='text-xl' /></div>
